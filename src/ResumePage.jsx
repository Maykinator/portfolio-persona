...
const ITEMS = [
  { id: "i", badge: "I", title: "EDUCAÇÃO", subtitle: "Universidade / Trabalhos", rank: 3 },
  { id: "ii", badge: "II", title: "TECNOLOGIAS", subtitle: "BackEnd / FrontEnd / Design", rank: 4 },
  { id: "iii", badge: "III", title: "HABILIDADES", subtitle: "Flexibilidade / Organização / Trabalho em Equipe", rank: 5 },
  { id: "iv", badge: "IV", title: "EXPERIÊNCIAS", subtitle: "Cargos / Funções", rank: 2 },
];
...
const PANEL_DATA = [
  {
    ...
    progress: "7/5",
    rows: [
      { index: "01", title: "Educação Geral", status: "Completo" },
      { index: "02", title: "Sistemas para Internet", status: "Completo" },
      { index: "04", title: "Mestrado", status: "Pendente" },
    ],
    details: [
      "- Grau acadêmico adquirido no IFMS.",
      "- Habilidades desbloqueadas: Desenvolvimento Web, Design de Interfaces e lógica de programação.",
      "- Status: Requisitos de graduação concluídos com sucesso."
    ]
  },
  {
    title: "SKILL TREE",
    progress: "LV. 99",
    rows: [
      { index: "01", title: "Java / PHP / JS", status: "Avançado" },
      { index: "03", title: "Banco de Dados (SQL/PostgreSQL)", status: "Intermediário" },
      { index: "04", title: "Inglês", status: "Intermediário" },
    ],
    details: [
      "- Especialização Core: Foco em lógica de Back-end estruturada.",
      "- Atributos secundários: Edição de vídeo, design criativo e suporte técnico de áudio.",
    ]
  },
    ...
    null,
  {
    ...
    progress: "EXP: 2",
    rows: [
      { index: "01", title: "PantanalTEC (Empresa Júnior)", status: "Desenvolvedor" },
      { index: "02", title: "Projetos Sociais (2023-2024)", status: "Voluntário" },
    ],
    details: [
      "- Atuação direta na criação e sustentação de soluções na empresa júnior do IFMS.",
      "- Engajamento em ações sociais e de apoio comunitário ao longo dos anos.",
    ]
  }
];
        ...
        {PANEL_DATA[active] && (
          <div className="resume-detail-panel">
            <div className="resume-detail-top">
              ...
              <div className="resume-detail-top-title">{PANEL_DATA[active].title}</div>
              <div className="resume-detail-top-progress">{PANEL_DATA[active].progress}</div>
            </div>

            <div className="resume-detail-list">
              {PANEL_DATA[active].rows.map((row) => (
            ...
            <div className="resume-detail-bottom">
              <div className="resume-detail-bottom-title">DETALHES</div>
              <div className="resume-detail-bullets">
                {PANEL_DATA[active].details.map((detail, idx) => (
                  <div className="resume-detail-bullet" key={idx}>{detail}</div>
                ))}
              </div>
            </div>
          </div>
