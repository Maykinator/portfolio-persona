...
const REVEAL_CONTENT = [
  {
    upper: ["Nome: Maykel Ribeiro Guppi", "Localizaçâo: Campo Grande - MS", "Idade: 22"],
    lower: "Formação: Sistemas para Internet",
  },
  {
    upper: [
      "Desenvolvimento Back-end utílizando Java, PHP e JavaScript.",
      "Já atuei como desenvolvedor na empresa júnior Pantanal-Tech.",
      "Idiomas: Português (Nativo) e Inglês (Intermediário).",
    ],
    lower: "algumas das minhas habilidades!.",
  },
  {
    upper: [
